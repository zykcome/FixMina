...
public class FixNorthClientHandler extends IoHandlerAdapter
{

	public static Logger logger = Logger.getLogger(FixNorthClientHandler.class);
	public DataTypeUtil dataTypeUtil;
	
	public FixNorthClientHandler()
	{
	...
	public void messageReceived(IoSession session, Object message) throws Exception
	{
		...
		if(msg.getMsgLength() == 0x120)
		{
			...
			//System.out.println("收到的火灾藐视 :" + String.valueOf(event.getDescription()));
